...
var app = angular.module('viewCustom', ['angularLoad', 'hathiTrustAvailability']);
    ...
    /****************************************************************************************************/
        ...
        /*var app = angular.module('centralCustom', ['angularLoad', 'hathiTrustAvailability']);*/

    /****************************************************************************************************/

app.component('prmSearchResultAvailabilityLineAfter', {
  template: '<hathi-trust-availability hide-online="false" hide-if-journal="false" ignore-copyright="true" entity-id="urn:mace:incommon:ucsb.edu"></hathi-trust-availability>'
});
...
app.component('prmLogoAfter', {
  ...
  template: '<div class="product-logo product-logo-local" layout="row" layout-align="start center" layout-fill id="banner" tabindex="0"  role="banner">' + '<a href="http://www.library.ucsb.edu/"><img class="logo-image" alt="{{::(&apos;nui.header.LogoAlt&apos; | translate)}}" ng-src="{{$ctrl.getIconLink()}}"/></a></div>'
});
    ...
    var handleResponse = function handleResponse(bibData) {
      ...
      for (var i = 0; !fullTextUrl && i < ids.length; i++) {
        ...
        for (var j = 0; j < result.items.length; j++) {
          ...
          if (item.usRightsString.toLowerCase() === ('full view' || 'Limited (search-only)' || 'temporary access')) {
