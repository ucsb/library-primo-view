...
var alertBanner = window.setInterval(function () {
  ...
  if (date.getFullYear() == 2023 && date.getMonth() > 7  && date.getMonth() < 10) {
    ...
    if ((date.getMonth() == 8 && date.getDate() > 10 && date.getDate() < 23)) {
      ...
      alertBarInnerDiv.setAttribute('style', 'text-align: center;background-color: #FFCE34;padding: 3px 0;font-size: 24px; color: #000000; font-family: hind_regularregular, Helvetica, Arial, sans-serif; line-height: 1.5em; font-weight: 600');
